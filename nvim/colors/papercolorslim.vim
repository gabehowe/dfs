...
" built-in
hi! clear doxygenBrief
execute "hi doxygenSpecial guifg=" . g:terminal_color_6
execute "hi doxygenBrief guifg=" . g:terminal_color_3
execute "hi doxygenComment guifg=" . g:terminal_color_3
execute "hi doxygenSpecialMultilineDesc guifg=" . g:terminal_color_3

hi @namespace               guifg=#af87d7
hi @lsp.type.class 			guifg=#00afaf gui=bold
hi link pythonDecoratorName Define
hi pythonDecorator 	guifg=#af87d7
...
hi DiffAdd                  guifg=#d0d0d0 guibg=#183300 gui=NONE
hi DiffChange               guifg=#d0d0d0 guibg=#183939 gui=NONE
hi DiffDelete               guifg=#d0d0d0 guibg=#550d0d gui=NONE
hi DiffText                 guifg=#d0d0d0 guibg=#004f4f gui=NONE
...
hi Constant                 guifg=#ff5faf guibg=NONE    gui=nocombine,NONE
...
hi Function                 guifg=#5fafd7 guibg=NONE    gui=nocombine,bold
hi Statement                guifg=#afd700 guibg=NONE    gui=NONE
hi Conditional              guifg=#af87d7 guibg=NONE    gui=bold
hi Repeat                   guifg=#afd700 guibg=NONE    gui=NONE
hi Label                    guifg=#af87d7 guibg=NONE    gui=nocombine,NONE
hi Operator                 guifg=#af87d7 guibg=NONE    gui=bold
hi Keyword                  guifg=#afd700 guibg=NONE    gui=NONE
hi Exception                guifg=#af87d7 guibg=NONE    gui=NONE
...
hi Type                     guifg=#afd700 guibg=NONE    gui=nocombine,NONE
hi StorageClass             guifg=#d7875f guibg=NONE    gui=bold
...
hi SpecialComment           guifg=#d7af5f guibg=NONE    gui=bold
